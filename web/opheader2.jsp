<%-- 
    Document   : homeop
    Created on : 19 Feb, 2015, 5:35:59 PM
    Author     : VIKAS
--%>
...
<html>
    <head>
         <meta charset="UTF-8">
        <title>operational department</title>
                        ...
                        <header>
                            ...
                            <nav>
                                <ul id="menu">
                                    ...
                                    <li class="nav2"><a href="home1.jsp">Asset</a></li>
                                    <li class="nav3"><a href="depreciation.jsp">Depreciation</a></li>
                                    <li class="nav4"><a href="#page_5">Scrap</a></li>
                                    <li class="nav5"><a href="#page_6">Reports</a></li>
                                </ul>
                            </nav>
                        </header>
                        <!--header end-->
